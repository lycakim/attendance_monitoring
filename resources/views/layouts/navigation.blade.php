    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex text-center my-3 text-xl">
                    <span class="badge text-bg-success capitalize" id="event_badge">{{ Session::get('option') }}
                        monitoring in progress</span>
                </div>
                @endif
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="mt-3 space-y-1">
                ...
                <x-responsive-nav-link data-bs-toggle="modal" id="#generateReport" data-bs-target="#generateReports">
                    {{ __('Generate Reports') }}
                </x-responsive-nav-link>
